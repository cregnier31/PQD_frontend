  ...
  return (
    ...
    >
      ...
      <XAxis
        ...
        style={{fontSize: 9}}
      />
      <YAxis style={{fontSize: 9, fontWeight: 'bold'}} />
      {GraphList(props.series_data)}
      <DiscreteColorLegend items={props.series_name} orientation='horizontal' style={{fontWeight: 'bold', fontSize: 10, position: 'absolute', left: '15px', top: '230px', height: 48, borderRadius:15}} />
    </FlexibleXYPlot>
  )
}
